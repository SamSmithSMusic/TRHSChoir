...
function edit(performance) {
  ...
  //Concert DropDown
  document
    .querySelector(".dropDownLabel.concert .new-concert")
  ...
  //Choir Dropdown
  document
    .querySelector(".dropDownLabel.choir .new-choir")
    .addEventListener("click", () => {
  ...
  //Year Dropdown
  document
    .querySelector(".dropDownLabel.year .new-year")
    .addEventListener("click", () => {
...
function getFormStructure(performance, choirs, concerts, years) {
  ...
  <form id="editForm">
              ...
              <div class="dropDownLabel choir"> <select list="choirs" id="choir" name="Choir" value="${
                performance.Choir || ""
              }" required>
                  ${choirs
                    .map(
                      (choir) =>
                        `<option value="${choir}" ${
                          choir === performance.Choir ? "selected" : ""
                        }>${choir}</option>`
                    )
                    .join("")}
              ...
              <div class="dropDownLabel concert"> <select list="concerts" id="concert" name="Concert" value="${
                performance.Concert || ""
              }" required>
                  ${concerts
                    .map(
                      (concert) =>
                        `<option value="${concert}" ${
                          concert === performance.Concert ? "selected" : ""
                        }>${concert}</option>`
                    )
                    .join("")}
              ...
              <div class="dropDownLabel year"> <select list="years" id="year" name="Year" value="${
                performance.Year || ""
              }" required>
                  ${years
                    .map(
                      (year) =>
                        `<option value="${year}" ${
                          year === performance.Year ? "selected" : ""
                        }>${year}</option>`
                    )
                    .join("")}
...
window.onload = function () {
  document.querySelector(".updateMessage").innerText =
    "Attempting to Load Performances...";
